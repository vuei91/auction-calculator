const PublicPriceInfo = ({
  ...
  setPublicPrice,
  guaranteeInsurance,
  setGuaranteeInsurance,
  houseCount,
  setHouseCount,
  propertyTax,
  setPropertyTax,
  comprehensiveRealEstateTax,
  setComprehensiveRealEstateTax,
  handleNumberInput,
  ...
  return (
    <div className="section">
      ...
      <div className="input-group">
        <label>
          보증보험료 (원)
          <button type="button" className="auto-calc-btn" onClick={onCalculateGuaranteeInsurance}>
            자동계산
          </button>
        </label>
        <input
      ...
      <div className="input-group">
        <label>
          재산세 (원)
          <button type="button" className="auto-calc-btn" onClick={onCalculatePropertyTax}>
            자동계산
          </button>
        </label>
        <input
      ...
      <div className="input-group">
        <label>
          종합부동산세 (원)
          <button type="button" className="auto-calc-btn" onClick={onCalculateComprehensiveRealEstateTax}>
            자동계산
          </button>
        </label>
        <input
